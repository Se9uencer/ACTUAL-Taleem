          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card className="border border-gray-200 shadow-sm">
              <CardContent className="p-4 flex flex-col items-center text-center">
                ...
                <h3 className="font-medium text-gray-900 mb-1">Manage Students</h3>
            ...
            <Card className="border border-gray-200 shadow-sm">
              <CardContent className="p-4 flex flex-col items-center text-center">
                ...
                <h3 className="font-medium text-gray-900 mb-1">Create Assignment</h3>
            ...
            <Card className="border border-gray-200 shadow-sm">
              <CardContent className="p-4 flex flex-col items-center text-center">
                ...
                <h3 className="font-medium text-gray-900 mb-1">Create Class</h3>
                    ...
                    <CardContent className="p-3">
                      <div className="flex justify-between items-start">
                        ...
                        <div className="flex items-center text-xs text-gray-500">
                          ...
                          <p className={`text-xs ${dynamicAccent.icon.primary}`}>
